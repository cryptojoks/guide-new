...
> **Disclaimer: Das [Antofy Wallet](https://antofy.money) wurde von [Antofy Labs LLC.](https://antofy.io), hergestellt, dem Unternehmen hinter diesen Leitfäden.**

Im Folgenden gehen wir auf einige wichtige Punkte ein, die bei der Verwendung von Non-Custodial Wallet-Apps zu beachten sind. Wir werden die Antofy Wallet-App verwenden, um diese wichtigen Aspekte zu veranschaulichen.
...
- Die Option „Wallet wiederherstellen“ stellt ein existierendes Wallet wieder her, das früher in Antofy oder einem anderen standardkonformen Wallet erstellt worden sein könnte.
...
Antofy will in einfachen Worten einen umfassenden Überblick über die verschiedenen Kryptowährungen geben.
...
Ein Wallet wie Antofy kann den Benutzer benachrichtigen, wenn sich der Anlagenpreis innerhalb von 24 Stunden um mehr als 2/3/5% verändert hat.

![portrait](../images/05-07-s.png)

Darüber hinaus kann das Antofy Warnungen versenden, wenn sich der Preistrend der Kryptowährung ändert, was auf einen guten Zeitpunkt für den Kauf oder Verkauf einer bestimmten Kryptowährung hinweist.
...
- **Blockchain-Privatsphäre**
    ...
    Bestimmte Non-Custodial Wallets können zusätzliche Merkmale aufweisen, die den Datenschutz auf dieser speziellen Blockchain erhöhen. Zum Beispiel integriert die Antofy Wallet-App bestimmte Instrumente, die das Verbinden verschiedener Blockchain-Transaktionen mit einer einzigen Einheit erheblich erschweren.
