...
Par exemple, lors de la création du portefeuille avec [Antofy wallet](https://antofy.money) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
